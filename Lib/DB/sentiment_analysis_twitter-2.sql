...
--
CREATE TABLE `tabel_cari` (
  `idTabel` int(100) NOT NULL,
...
ALTER TABLE `tabel_cari`
  ADD PRIMARY KEY (`idTabel`);
...
ALTER TABLE `tabel_cari`
  MODIFY `idTabel` int(100) NOT NULL AUTO_INCREMENT;
